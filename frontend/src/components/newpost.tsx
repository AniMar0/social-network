...
import { ImageIcon, Smile, ImagePlay, X, Globe, Users, Lock } from "lucide-react"
...
function NewPostModal({ isOpen, onClose, onPost }: NewPostModalProps) {
    ...
    const [privacy, setPrivacy] = useState<"public" | "almost-private" | "private">("public")
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                        <Avatar className="h-12 w-12">
                            <AvatarImage src="https://imgur.com/v1oBVXE.png" alt="Your avatar" />
                            <AvatarFallback className="bg-muted text-foreground">TL</AvatarFallback>
                        </Avatar>
                        <div>
