...
export function ExplorePage({ onNavigate, onNewPost }: ExplorePageProps) {
    ...
    const handleFollowToggle = async (userId: string) => {
        ...
        try {
            console.log(user.isFollowing ? "Unfollowing user:" : "Following user:", userId);
            // TODO: Replace with actual API call
            ...
            <div className="flex-1 lg:ml-64 min-w-0">
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="p-6 border-b border-border bg-card">
                        <h1 className="text-2xl font-bold text-foreground mb-4 lg:ml-0 ml-12">Explore</h1>
                            ...
                            {filteredUsers.map((user) => (
                                ...
                                >
                                    <div className="flex flex-col items-center text-center">
                                        ...
                                        <p className="text-sm text-foreground mb-4 line-clamp-2">{user.bio}</p>
