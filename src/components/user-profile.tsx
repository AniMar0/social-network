...
import { Heart, MessageCircle, Share2, Mail, Calendar, Users, MessageSquare, Lock } from "lucide-react"
...
function UserProfile({ isOwnProfile = false, isFollowing = false, userData, posts = [] }: UserProfileProps) {
    ...
    const handleFollowToggle = () => {
        ...
        console.log(followingState ? "Unfollowing user" : "Following user")
    }
    ...
    return (
        <div className="min-h-screen bg-background flex">
            ...
            <aside className="fixed top-0 left-0 h-screen w-64 z-30 border-r border-border bg-card">
                <SidebarNavigation activeItem="profile" onNavigate={handleNavigation} onNewPost={handleNewPost} />
            </aside>
            ...
            <main className="flex-1 ml-64">
                ...
                <div className="bg-card border-b border-border">
                    <div className="max-w-4xl mx-auto p-6 relative">
                        <div className="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            {isOwnProfile && (
                                <div className="absolute right-6 top-6">
                                    <ProfileSettings userData={profileData} onSave={handleProfileUpdate} />
                                </div>
                            )}
                        {/* Avatar */}
                        ...
                        <Avatar className="h-32 w-32 border-4 border-primary/20 flex-shrink-0">
                            <AvatarImage
                                src={profileData.avatar || `/placeholder.svg?height=128&width=128&query=user+avatar`}
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <div>
                                ...
                                {profileData.nickname && <p className="text-lg text-muted-foreground">@{profileData.nickname}</p>}
                            </div>

                            {/* Bio */}
                            {/* About me / bio */}
                            {profileData.aboutMe && (
                                <p className="text-foreground leading-relaxed max-w-2xl">{profileData.aboutMe}</p>
                            )}
                ...
                <div className="max-w-4xl mx-auto p-6">
                    <div className="mb-6">
                        <h2 className="text-2xl font-bold text-foreground border-b border-primary pb-2">Posts</h2>
                    </div>
                    ...
                    {canViewPosts ? (
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="flex items-center gap-3 mb-4">
                                                <Avatar className="h-10 w-10">
                                                    <AvatarImage
                                                        src={profileData.avatar || `/placeholder.svg?height=40&width=40&query=user+avatar`}
                                                        alt={`${profileData.firstName} ${profileData.lastName}`}
                                                    />
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div className="flex items-center gap-6 pt-2 border-t border-border">
                                                    ...
                                                    <button
                                                        ...
                                                        className={`flex items-center gap-2 text-sm hover:text-primary transition-colors ${likedPosts.has(post.id) ? "text-primary" : "text-muted-foreground"}`}
                                                    >
                        ...
                        <Card className="bg-card border-border">
                            <CardContent className="p-12 text-center">
                                ...
                                <h3 className="text-xl font-semibold text-foreground mb-2">This profile is private</h3>
                                ...
                                {!isOwnProfile && (
                                    <div className="flex justify-center">
                                        <Button onClick={handleFollowToggle} className="flex items-center gap-2 cursor-pointer">
                                            <Users className="h-4 w-4" />
                                            Send Follow Request
                                        </Button>
                                    </div>
